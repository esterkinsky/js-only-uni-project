Template.prototype.Menu = () =>
	`<div class="menu">
		...
		<div class="menu-item" data-item="polycalculator">PolyCalculator</div>
		<div class="menu-item" data-item="canvasContent" id="canvas-button">Graph2d</div>
		<div class="menu-item" data-item="canvas3dContent" id="3d-button">Graph3d</div>
	</div>`